...
function makeSvg(calendar, mode) {
  ...
  return [
    ...
    '<circle cx="24" cy="35" r="4" fill="' + accent + '" filter="url(#softGlow)"/>',
    '<circle cx="42" cy="39" r="3.5" fill="' + text + '"/>',
    '<circle cx="58" cy="41" r="4.5" fill="' + accent + '" filter="url(#softGlow)"/>',
    '<circle cx="74" cy="39" r="3.5" fill="' + text + '"/>',
    '<circle cx="92" cy="35" r="4" fill="' + accent + '" filter="url(#softGlow)"/>',
