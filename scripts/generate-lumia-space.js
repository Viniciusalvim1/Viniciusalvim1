...
'<rect x="' + (gridX - 12) + '" y="' + (gridY - 82) + '" width="' + (gridW + 42) + '" height="' + (gridH + 135) + '" rx="24"/>',
'</clipPath>',
'</defs>',
...
'.ufoMove{animation:ufoMove 8s ease-in-out infinite;transform-box:fill-box;transform-origin:center}',
...
'.shipLightA{animation:blinkA 1.2s ease-in-out infinite}',
'.shipLightB{animation:blinkB 1.5s ease-in-out infinite}',
'.shipCore{animation:corePulse 1.8s ease-in-out infinite}',
...
'@keyframes blinkA{0%,100%{opacity:.35}50%{opacity:1}}',
'@keyframes blinkB{0%,100%{opacity:1}50%{opacity:.35}}',
'@keyframes corePulse{0%,100%{r:3.5;opacity:.7}50%{r:5.6;opacity:1}}',
...
'<text x="55" y="29" class="badge">NAVE LUMIA ATIVA...</text>',
'</g>',
...
'<g transform="translate(' + (gridX + 40) + ' ' + (gridY - 58) + ')">',
'<g class="ufoMove">',
'<g class="float">',
...
'<ellipse cx="58" cy="35" rx="52" ry="9" fill="' + panel + '" opacity="0.72"/>',
'<ellipse cx="58" cy="38" rx="34" ry="5" fill="' + accent + '" opacity="0.18"/>',
'<circle class="shipLightA" cx="24" cy="35" r="4" fill="' + accent + '" filter="url(#softGlow)"/>',
'<circle class="shipLightB" cx="42" cy="39" r="3.5" fill="' + text + '"/>',
'<circle class="shipCore" cx="58" cy="41" r="4.5" fill="' + accent + '" filter="url(#softGlow)"/>',
'<circle class="shipLightA" cx="74" cy="39" r="3.5" fill="' + text + '"/>',
'<circle class="shipLightB" cx="92" cy="35" r="4" fill="' + accent + '" filter="url(#softGlow)"/>',
'<path d="M10 35C23 48 93 48 106 35" stroke="' + accent + '" stroke-width="2" stroke-opacity="0.5" fill="none"/>',
